...
**Caution:**   Some things which might appear to be bearing surfaces fall into other categories. For example, stage should be coded functional place under PLACE Superset.  Stairs should be coded under paths in PLACE Superset. 
...
**Caution:**   Some conduit-type words fall into other categories.  E.g., A word like intestines should be coded as agentive.  Tubing should be coded under MASS Superset.
...
thresholds/focal points/barriers  [mnemonic: CObarr]    [3 34 525]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
undifferentiated functionals   [mnemonic: COundfunc ]    [3 34 217]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
undifferentiated agentive things   [mnemonic: COundagt]    [3 35 248]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
miscellaneous natural things [mnemonic: COmnat ]    [3 32 381]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
undifferentiated concrete things   [mnemonic: COobj]    [3 03 212]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
**Caution:**   Words like duck, quail, chicken, pheasant, turkey, capon, etc. which denote both birds and food and should be coded fowl/food.
...
**Examples:**   capon, chicken, duck, goose, pheasant, quail, squab, turkey
...
PLACE Noun Superset  [mnemonic: PL]   [9]
-------------------------------------------------------------------------------
...
* non-agentive proper name places.  These include the following subsets:
    ...
    * other non-agentive proper geo. entities                        (PLothprop), e.g. Swiss Alps
...
* cell should be microorganism under ANIMATE Superset
* parcel should be undiff.  concrete object under CONCRETE Superset
...
functional locations [mnemonic: PLfunc]    [9 26]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
agentive functional locations [mnemonic: PLagfunc]    [9 26 228]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
enclosed spaces  [mnemonic: PLencl]    [9 27]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
non-agentive common-noun geog. locations [mnemonic: PLnagcom]    [9 29]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
agentive geog. entities  [mnemonic: PLaggeo]    [9 94]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
countries/states/provinces  [mnemonic: PLcoun]    [9 94 230]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
cities [mnemonic: PLcity]    [9 94 226]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
agentive common-noun geog. entities [mnemonic: PLagcom]    [9 94 236]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
non-agentive proper geog. entities [mnemonic: PLnagprop]    [9 56]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
continents [mnemonic: PLcont]    [9 56 227]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
bodies of water [mnemonic: PLwater]    [9 56 229]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
other non-agentive proper geog. entities [mnemonic: PLothprop]    [9 56 238]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
undifferentiated place nouns  [mnemonic: PLundif]    [9 57]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
INFORMATION Noun Superset  [mnemonic: IN]    [12]
-------------------------------------------------------------------------------
...
games/rituals [mnemonic: INgame]    [12 74 224]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
symbolic data  [mnemonic: INsymb]    [12 75]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
recorded data  [mnemonic: INdata]    [12 76]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
evidence/symptoms [mnemonic: INevid]    [12 96]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
fields of knowledge   [mnemonic: INknow]    [12 78]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
the arts [mnemonic: INarts]    [12 78 225]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
storage media for recorded data [mnemonic: INstor]    [12 77]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
verbal abstracts  (re processes, behavior, persons as agents)  [mnemonic: ABverb]    [6 41]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
purpose [mnemonic: ABpur]    [6 41 748]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
method/process/procedure [mnemonic: ABmeth]    [6 41 733]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
cause/potential/disposition [mnemonic: ABcause]    [6 41 602]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
quality of action/agent [mnemonic: ABqual]    [6 41 655]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
negative causes [mnemonic: ABnegc]    [6 41 764]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
contrary events [mnemonic: ABcont]    [6 41 765]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
undifferentiated verbal abstracts (re processes, behavior, persons as agents)  [mnemonic: ABverb]    [6 41 41]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
In (1) and (2), the particle to has the sense of in order to.  If procedures and techniques in these sentences had been coded as method/process/procedure, the system would have seen the verbal clause as complementary to the noun, as in (3), rather than as adverbial to the sentence in effect,and therefore would not have have assigned the sense of to to the particle in order to.
...
non-verbal abstracts (re things, persons as non-agents)  [mnemonic: ABnonvb]    [6 40]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
properties/qualities/nature  [mnemonic: ABprop]    [6 40 609]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
states/conditions/relationships [mnemonic: ABstate]    [6 40 736]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
classifications [mnemonic: ABclass]    [6 40 731]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
sources/origins [mnemonic: ABorig]    [6 40 723]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
general abstract concepts [mnemonic: ABgen]    [6 42]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
PROCESS Noun (Intransitive) Superset  [mnemonic: PNin]    [4]
-------------------------------------------------------------------------------
...
PROCESS Noun (Transitive) Superset  [mnemonic: PNtr]    [7]
-------------------------------------------------------------------------------
...
abstract concepts measured by unit [mnemonic: MEabs]     [8 46]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
discrete measurable concepts [mnemonic: MEdis]    [8 95]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
units of measure [mnemonic: ME]    [8 61]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
units of weight [mnemonic: MEwt]    [8 61 161]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
units of velocity [mnemonic: MEvel]    [8 61 162]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
units of volume measure [mnemonic: MEvol]    [8 61 163]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
units of temperature [mnemonic: MEtemp]    [8 61 164]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
units of energy/force [mnemonic: MEener]    [8 61 165]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
measurement systems [mnemonic: MEsys]    [8 61 234]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
units of duration [mnemonic: MEdur]    [8 61 166]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
specialized units of measure [mnemonic: MEspec]    [8 61 167]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
units of money/value [mnemonic: MEvalue]    [8 61 168]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

**Definition:**    Nouns denoting monetary value or worth  

**Examples:**    cent, dollar, ducat, �cu, Eurodollar, farthing, franc, guilder, krugerrand, lira, mark, mill, penny, pfennig, pound sterling, ruble
...
units of linear/area measure [mnemonic: MElin]    [8 61 170]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
undifferentiated measure [mnemonic: MEundif]    [8 61 169]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
TIME Noun Superset  [mnemonic: TI]     [10]
-------------------------------------------------------------------------------
...
periods of the day [mnemonic: TIper]    [10 10 174]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
days of the week [mnemonic:TIday]    [10 10 171]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
months of the year [mnemonic: TImon]    [10 10 172]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
seasons of the year [mnemonic: TIsea]    [10 10 173]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
adverbial time nouns [mnemonic: TIadv]    [10 30 176]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
undifferentiated time [mnemonic: TIundif]    [10 30]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
aspective bearing surfaces [mnemonic: ASsurf]    [2 21]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
E.g., top = bearing surface under ASPECTIVE Superset.

When an aspective noun is compounded, code it by the code of its modifier.
E.g., counter top = bearing surface under CONCRETE Noun Superset.

When its modifier is weak in meaning, code the phrases as aspective. 
E.g., removable top = bearing surface under ASPECTIVE Superset.
...
aspective functionals  [mnemonic: ASfunc]    [2 58]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
When an aspective noun is compounded, code it by the code of its modifier.
E.g., table leg = structural element under CONCRETE Superset.

When its modifier is weak in meaning, code the phrases as aspective.
E.g., last leg = aspective functional  under ASPECTIVE Superset.
...
members/portions/parts [mnemonic: ASpart]    [2 24]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
When an aspective noun is compounded, code it by the code of its modifier.
E.g., wooden stage = bearing surface under CONCRETE Noun Superset.

When its modifier is weak in meaning, code the phrases as aspective.
E.g., intermediate stage = aspective members/portions/ parts under ASPECTIVE Superset.
...
aggregates  [mnemonic: ASaggr]    [2 92]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
When an ASPECTIVE Noun is a single word, code it according to its aspective code.
 E.g., set = aggregates under ASPECTIVE Superset.

When an aspective noun is compounded, code it by the code of its modifier.
E.g., manicure set = functional device/tool/instrument under CONCRETE Noun Superset.

When its modifier is weak in meaning, code the phrases as aspective.
E.g., mixed set = aggregates under ASPECTIVE Superset.
...
numeric groupings [mnemonic: ASnum]    [2 92 101]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
aspective receptacles [mnemonic: ASrecp]    [2 36]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
aspective thresholds/ focal points/ barriers/ limits [mnemonic: ASbarr]    [2 25]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
When an aspective noun is compounded, code it by the code of its modifier.
E.g., shopping center = functional location under PLACE Noun Superset.

When its modifier is weak in meaning, code the phrases as aspective.
E.g., turbulence center  =  focal point under ASPECTIVE Superset.
...
model/copy [mnemonic: AScopy]    [2 31]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
When an ASPECTIVE Noun is a single word, code it according to its aspective code.
E.g., copy = model/copy under ASPECTIVE Superset.

When an aspective noun is compounded, code it by the code of its modifier.
E.g., printed copy = recorded data under INFORMATION Noun Superset.

When its modifier is weak in meaning, code the phrases as aspective.
E.g., final copy = model/copy under ASPECTIVE Superset.
...
configurations/order [mnemonic: ASconf]    [2 28]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
When an ASPECTIVE Noun is a single word, code it according to its aspective code.
E.g., block = configurations/order under ASPECTIVE Superset.

When an aspective noun is compounded, code it by the code of its modifier. 
E.g., spinal block = strong verbal under ABSTRACT Noun Superset.

When its modifier is weak in meaning, code the phrases as aspective. 
E.g., square block = configurations/order under ASPECTIVE Superset.
...
aspective conduits [mnemonic: AScond]    [2 22]
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
When an ASPECTIVE Noun is a single word, code it according to its aspective code.
E.g., span = aspective conduit under ASPECTIVE Superset.

When an aspective noun is compounded, code it by the code of its modifier.
E.g., steel span = structural element under CONCRETE Superset.
E.g., time span = abstract concept measured by unit under the MEASURE Superset.

When its modifier is weak in meaning, code the phrases as aspective.
E.g., modified span = aspective conduit under ASPECTIVE Superset.
...
UNKNOWN Words Superset  [mnemonic: UN]    [1]
-------------------------------------------------------------------------------
...
E.g. 
    "This book has very little text, mostly illustrations."
